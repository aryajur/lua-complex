...
-- Add acosh,asinh,atanh functions to the math library
--------------------------------------------------------------------------------
...
function string.format(fmt,...)
  local arg_={}
  local arg = {...}		-- Added for Lua 5.2.3 compatibility (Milind 5/30/2014)
  for i=1,#arg do
